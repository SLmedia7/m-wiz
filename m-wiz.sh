...
echo -e "$red                              ⫸$ylo youtube.com/sl media$red ⫷$rset"
echo " "
echo " "
...
echo -e "$red                             ➡️$cyan [3️] Metasploit backup"
echo -e "$red                             ➡$cyan [4️] Metasploit restore"
echo -e "$red                             ➡️$cyan [5️] Metasploit delete"
echo -e "$red                             ➡$cyan [6️] Delete script"
echo -e "$red                             ➡️$cyan [7️] Update script"
echo -e "$red                             ➡$cyan [8️] About" 
echo -e "$red                             ➡️$cyan [9️] Reboot"
